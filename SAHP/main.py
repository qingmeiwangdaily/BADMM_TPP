...
parser.add_argument('--log-dir', type=str,
                    dest='log_dir', default='./logs/soft-dataso8-100.log',
...
parser.add_argument('-t', '--task', type=str, default='hawkes',
                    help = 'task type')
...
parser.add_argument('-wandb', type=str, default='SAHP')
parser.add_argument('-name', type=str, default='5-0.1-0.1')
parser.add_argument('-data', type=str, default='so/fold1')

parser.add_argument('-save_model', type=int, default=1)
parser.add_argument('-checkpoints_path', type=str, default='./checkpoints')
parser.add_argument('-checkpoint_model_path', type=str, default='./checkpoints')
...
TYPE_SIZE_DICT = {'taobao': 17, 'conttime': 5, 'retweet': 3, 'amazon': 16,
                  'hawkes': 5, 'missing': 5, 'so':22}  
REAL_WORLD_TASKS = list(TYPE_SIZE_DICT.keys())[:10]
SYNTHETIC_TASKS = list(TYPE_SIZE_DICT.keys())[10:]
...
if __name__ == '__main__':
    ...
    if args.task in SYNTHETIC_TASKS:
        ...
        train_path = '../data/' + args.data + '/train_manifold_format.pkl'
        dev_path = '../data/' + args.data + '/dev_manifold_format.pkl'
        test_path = '../data/' + args.data + '/test_manifold_format.pkl'
